<template>
  <div class="app">
    <AppHeader fixed>
      <b-link class="navbar-brand" to="/candidates/vacancy">
        <img class="navbar-brand-full" src="img/logo.png"  alt="CoreUI Logo">
      </b-link>
      <b-navbar-nav class="d-md-down-none">
        <b-nav-item class="px-3" to="/candidates/vacancy">Vagas</b-nav-item>
        <b-nav-item class="px-3" to="/candidates/personalData">Meu Perfil</b-nav-item>
      </b-navbar-nav>
