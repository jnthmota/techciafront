<template>
  <div class="animated fadeIn">
    <b-row>
      ...
      <b-col md="2">
        <b-link to="/vacancyCreate" variant="primary">
          ...
          <b-card class="card-accent-warning" no-body v-if="show">
            <div slot="header">
              ...
              <div class="card-header-actions">
                <b-link :to="{path: '/vacancyCandidate/'+vacancy._id}" class="card-header-action btn-setting">
...
export default {
  ...
  beforeMount() {
    this.$store.dispatch("getVacancy").then(res => {
      setTimeout(res => {
        this.vacancys = this.$store.getters.vacancys;
      }, 1000);
    });
  }
};
