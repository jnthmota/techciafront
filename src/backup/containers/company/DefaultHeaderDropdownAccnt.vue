<template>
  <AppHeaderDropdown right no-caret>
    ...
    <template slot="dropdown">
      ...
      <b-dropdown-item><i class="fa fa-user" /> Minha Empresa</b-dropdown-item>
       <b-dropdown-item to="/candidates/personalData"><i class="fa fa-pencil"  /> Editar Perfil</b-dropdown-item>
