<template>
  <div class="form register-hunter">
    <form  v-on:submit="handleSubmit()">
      ...
      <b-form-group>
        <b-form-input v-model="user.password" type="text" id="password" placeholder="Digite sua senha"></b-form-input>
      </b-form-group>
      <b-form-group>
        <b-form-input v-model="confirmPassword" type="text" id="password-confirm" placeholder="Confirme a sua senha"></b-form-input>
      </b-form-group>
